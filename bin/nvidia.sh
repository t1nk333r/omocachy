...
# adapted from mroboff/omarchy-on-cachyos' nvidia.sh; here it reports the
...
# decode (adopted from mroboff/omarchy-on-cachyos).
...
# overridden (adopted from mroboff/omarchy-on-cachyos).
